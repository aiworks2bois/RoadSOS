...
from sqlalchemy import ARRAY, Boolean, Column, DateTime, Float, ForeignKey, String, Text, func
...
class Volunteer(Base):
    ...
    def set_location_from_coords(self, lat: float, lng: float) -> None:
        self.lat = lat
        self.lng = lng
        self.location = None  # PostGIS not available locally; lat/lng are the source of truth
