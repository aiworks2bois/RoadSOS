...
class Settings(BaseSettings):
    ...
    ALGORITHM: str = "HS256"
    ACCESS_TOKEN_EXPIRE_MINUTES: int = 60 * 24  # 24 h — safe window; 7-day default is too wide for device-theft risk
    ...
    MESH_RELAY_MAX_AGE_SECONDS: int = 72 * 60 * 60
    ...
    def production_config_errors(self) -> list[str]:
        ...
        if not (300 <= self.MESH_RELAY_MAX_AGE_SECONDS <= 7 * 24 * 60 * 60):
            errors.append("MESH_RELAY_MAX_AGE_SECONDS must be between 300 seconds and 7 days")
